...
sBoxs[7].addEventListener("mouseover", function() {
  sBoxs[7].style.backgroundColor = "rgba(239,118,255, .8)";
  sBoxs[7].style.boxShadow = "rgb(0 0 0 / 19%) 0px 10px 20px, rgb(0 0 0 / 23%) 0px 6px 6px";
  sParas[7].style.fontWeight = "500";
  sImgs[7].style.transform = "rotate(20deg)";
});

sBoxs[7].addEventListener("mouseout", function() {
  sBoxs[7].style.backgroundColor = "rgb(239,118,255)";
  sBoxs[7].style.boxShadow = "none";
  sParas[7].style.fontWeight = "300";
  sImgs[7].style.transform = "none";
});
