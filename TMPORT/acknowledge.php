...

{
  ...
  $headers = "From: hi@tianamariah.com"


  mail("hi@tianamariah.com", $subject, $mailBody, "From: $sender <$senderEmail>");

  $thankYou="<h5>Your message has been sent!<br><br>I will be in contact.</h5>";
}
    ...
    <div id="navigation">
      <nav class="navbar navbar-light" style="background-color: #ffffff;">
		...
		<header>
          ...
          <br>
          <p><a href="home.html"><img src="img/tmm.jpg" alt="Photo of author" class="rounded-circle img-fluid img-thumbnail" width="100" height="100" id="photo"/></a></p>
		</header>
    <div class="container-fluid" id="intro">
      <p> Hey, there! My name is Tiana and I enjoy designing and building functional websites.</p>
       I also find joy in...</p>
      <p><span id="hobbies">drinking tea <i class="fa fa-coffee" aria-hidden="true"></i></span></p>
      <p><a href="tiana_mangual_resume_2018.pdf" download="Mangual_Tiana_Resume_2018">Download my resume here</a>.</p>
      <p>To get in touch, <a href="#three">check the contact section</a>.</p>
    </div>

		<div class="container-fluid" id="mainAccordion" role="tablist">
	  	<div class="card">
	    	<div class="card-header" data-toggle="collapse" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne" role="tab" id="headingOne">
	      	<p class="mb-0">
				...
				<div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#mainAccordion">
          <div class="row" id="resumeSection">
			...
			<div class="card">
	    	<div class="card-header" data-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseOne" role="tab" id="headingTwo">
	      	<p class="mb-0">
				...
				<div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo" data-parent="#mainAccordion">
	      	<div class="card-body">
						<div class="row">
	  					<div class="col-lg">
                <hr>
                <h5 class="card-title">Fairy Good Cook</h5>
                <hr>
                <div class="card" style="width: 12rem;" id="cardProjects">
                  <img class="card-img-top" src="img/img_fgc.jpg" alt="Card image cap">
                  <div class="card-body">
                    <p class="card-text">A site re-design for FairyGoodCook.com </p>
                    <p class="card-text">Using HTML5, CSS3, JavaScript & Bootstrap, I developed a a responsive site for Chef Nilda.</p>
                    <br>
	        					<p><a href="https://tianamariah.github.io/FGC/home.html" target="_blank" class="btn btn-outline-light"  id="btnProjects">View Project</a></p>
                  </div>
                </div>
              </div>
              <div class="col-lg">
                <hr>
                <h5 class="card-title">Tidewater Concert Band</h5>
                <hr>
                  <div class="card" style="width: 12rem;" id="cardProjects">
                    <img class="img-fluid card-img-top" src="img/img_tcb.jpg" alt="Card image cap">
                    <div class="card-body">
                      <p class="card-text"> Created a responsive and user-oriented site for TCB.</p>
                      <p class="card-text">Project Contributions: Site Layout, Responsive Design, Bootstrap Carousel </p>
                        <br>
                      <a href="https://tianamariah.github.io/TCB/index.html" class="btn btn-outline-light"  target="_blank" id="btnProjects">View Project</a>
                    </div>
                  </div>
  	  					</div>
                <div class="col-lg">
                  <hr>
                  <h5 class="card-title">Countdown til' Baby</h5>
                  <hr>
                    <div class="card card-dark" style="width: 12rem;" id="cardProjects">
                      <img class="card-img-top" src="img/img_cd.jpg"alt="Card image cap">
                      <div class="card-body">
                        ...
                        <a href="https://tianamariah.github.io/BCD/index.html" class="btn btn-outline-light"  target="_blank" id="btnProjects">View Project</a>
                      </div>
                    </div>
                  </div>
	  					</div>
  		...
  		<div class="card">
	    	<div class="card-header" data-toggle="collapse" href="#collapseThree" aria-expanded="false" aria-controls="collapseOne" role="tab" id="headingThree">
	      	<p class="mb-0">
        ...
        <div class="row">
         <div class="col-sm">
            ...
            <span style="font-family:'Nothing You Could Do', cursive;text-shadow: .5px .5px #ececec;"><?=$thankYou ?></span>
          </div>
        </div>
        <div class="col-sm">
          ...
          <form action="acknowledge.php" method="post">
            ...
            <input type="submit" name="send" class="btn btn-outline-light"  id="contactButton">
