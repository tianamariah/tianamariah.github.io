          ...
          <div class="row" id="resumeSection">
	    	...
	    	<div class="card-header" role="tab" id="headingTwo">
	      	...
	      	<div class="card-body">
                ...
                <hr>
                <div class="card" style="width: 15rem;" id="cardProjects">
              ...
              <div class="col-lg">
                ...
                <hr>
                  <div class="card" style="width: 15rem;" id="cardProjects">
                    <img class="img-fluid card-img-top" src="img/img_tcb.png" alt="Card image cap">
                    <div class="card-body">
                ...
                <div class="col-lg">
                  ...
                  <hr>
                    <div class="card card-dark" style="width: 15rem;" id="cardProjects">
  		...
  		<div class="card">
	    	<div class="card-header" role="tab" id="headingThree">
	      	<p class="mb-0">
				...
				<div id="collapseThree" class="collapse " role="tabpanel" aria-labelledby="headingThree" data-parent="#mainAccordion">
        <div class="row">
         <div class="col-sm">
