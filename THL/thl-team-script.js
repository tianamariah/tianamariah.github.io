...
document.getElementById("overLayOne").addEventListener("click", function() {
  const getModalBox =document.getElementsByClassName("modalBoxOne");
...
document.getElementById("overLayTwo").addEventListener("click", function() {
  const getModalBox =document.getElementsByClassName("modalBoxTwo");
  getModalBox[0].style.display = 'block';
});
...
document.getElementById("overLayThree").addEventListener("click", function() {
  const getModalBox = document.getElementsByClassName("modalBoxThree");
  getModalBox[0].style.display = 'block';
});
...
document.getElementById("overLayFour").addEventListener("click", function() {
  const getModalBox = document.getElementsByClassName("modalBoxFour");
  getModalBox[0].style.display = 'block';
});
...
document.getElementById("overLayFive").addEventListener("click", function() {
  const getModalBox = document.getElementsByClassName("modalBoxFive");
  getModalBox[0].style.display = 'block';
});
...
document.getElementById("overLaySix").addEventListener("click", function() {
  const getModalBox = document.getElementsByClassName("modalBoxSix");
  getModalBox[0].style.display = 'block';
});
...
document.getElementById("overLaySeven").addEventListener("click", function() {
  const getModalBox = document.getElementsByClassName("modalBoxSeven");
  getModalBox[0].style.display = 'block';
});
...
document.getElementById("overLayEight").addEventListener("click", function() {
  const getModalBox = document.getElementsByClassName("modalBoxEight");
  getModalBox[0].style.display = 'block';
});
...
document.getElementById("overLayNine").addEventListener("click", function() {
  const getModalBox = document.getElementsByClassName("modalBoxNine");
  getModalBox[0].style.display = 'block';
});
...
document.getElementById("overLayTen").addEventListener("click", function() {
  const getModalBox = document.getElementsByClassName("modalBoxTen");
  getModalBox[0].style.display = 'block';
});
...
document.getElementById("overLayEleven").addEventListener("click", function() {
  const getModalBox = document.getElementsByClassName("modalBoxEleven");
  getModalBox[0].style.display = 'block';
});
...
document.getElementById("overLayTwelve").addEventListener("click", function() {
  const getModalBox = document.getElementsByClassName("modalBoxTwelve");
  getModalBox[0].style.display = 'block';
});
...
document.getElementById("overLayThirteen").addEventListener("click", function() {
  const getModalBox = document.getElementsByClassName("modalBoxThirteen");
  getModalBox[0].style.display = 'block';
});
...
document.getElementById("overLayFourteen").addEventListener("click", function() {
  const getModalBox = document.getElementsByClassName("modalBoxFourteen");
  getModalBox[0].style.display = 'block';
});

document.getElementById("closeFourteen").addEventListener("click", function() {
  const getModalBox = document.getElementsByClassName("modalBoxFourteen");
  getModalBox[0].style.display= 'none';
